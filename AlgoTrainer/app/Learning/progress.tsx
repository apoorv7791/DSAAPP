...
const Progress = () => {
    ...
    const { completedById, loaded, toggleTopic, refresh, isDone } = useLearningProgress();
    ...
    const dataStructures = LEARNING_TOPICS.filter(t => t.label.includes('Array') || t.label.includes('List') || t.label.includes('Stack') || t.label.includes('Queue') || t.label.includes('Hash') || t.label.includes('Tree') || t.label.includes('Graph') || t.label.includes('Heap'));
    const algorithms = LEARNING_TOPICS.filter(t => t.label.includes('Sort') || t.label.includes('Search'));
    const advanced = LEARNING_TOPICS.filter(t => t.label.includes('DP') || t.label.includes('Greedy') || t.label.includes('Recursion') || t.label.includes('Graph Algorithms'));
        ...
        <ScrollView style={styles.container} contentContainerStyle={styles.content}>
            ...
            <Card theme={theme} variant="elevated" style={styles.summaryCard}>
                <View style={styles.summaryRow}>
                    ...
                    <View style={styles.summaryItem}>
                        <Text style={styles.summaryValue}>{LEARNING_TOPICS.length - completed}</Text>
            ...
            <View style={styles.categoryGrid}>
                <Card theme={theme} variant="outlined" style={styles.categoryCard}>
                    <View style={styles.categoryContent}>
                        ...
                        <Text style={[typography.labelSmall, { color: theme.textSecondary, marginTop: 8 }]}>
                            Data Structures
                        </Text>
