        ...
        <ScrollView style={styles.container}>
                    ...
                    {Array.from({ length: parseInt(n) || 0 + 1 }).map((_, i) => (
                        <View key={i} style={styles.cellWrapper}>
                            ...
                            <View style={[
                                ...
                                <Text style={[
                                    styles.cellText,
                                    (currentIndex === i || table[i] !== undefined) && { color: '#fff' }
                                ]}>
            ...
            <View style={styles.explanation}>
                ...
                <Text style={styles.explanationText}>
                    ...
                    4. This avoids re-calculating the same values multiple times (Efficiency!).
                </Text>
            </View>
        </ScrollView>
    );
...
const getStyles = (theme: any) => StyleSheet.create({
    ...
    button: { backgroundColor: theme.primary, paddingHorizontal: 20, height: 45, borderRadius: 8, justifyContent: 'center' },
    buttonDisabled: { opacity: 0.6 },
    buttonText: { color: '#fff', fontWeight: '600' },
    tableContainer: { marginBottom: 30 },
    sectionTitle: { fontSize: 16, fontWeight: 'bold', color: theme.text, marginBottom: 15 },
    ...
    explanation: { padding: 16, backgroundColor: theme.bgCard, borderRadius: 12, borderWidth: 1, borderColor: theme.border },
    explanationTitle: { fontSize: 14, fontWeight: 'bold', color: theme.primary, marginBottom: 8 },
    explanationText: { fontSize: 13, color: theme.textSecondary, lineHeight: 20 },
});
