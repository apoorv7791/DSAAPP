...
const Settings = () => {
    ...
    ], [theme.mode, isLoggedIn, logout, t, toggleTheme, theme.border, theme.primary, theme.text, theme.textSecondary]);
            ...
            case 'auth':
                return (
                    <View style={[spacingUtils.mx.lg, { marginBottom: 16 }]}>
                        ...
                        >
                            <Text style={[typography.bodyMedium, { color: theme.text, textAlign: 'center', marginBottom: 12 }]}>
