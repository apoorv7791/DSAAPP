    ...
    () => [
      {
        ...
        topics: [
          ...
          {
            name: "LinkedList",
            displayName: t("topics.linkedList"),
      ...
      },
      {
        ...
        topics: [
          ...
          {
            name: "Searching",
            displayName: t("topics.searching"),
            icon: "search-outline",
            route: "searching",
            right: null,
          },
        ...
        topics: [
          {
            ...
            displayName: t("topics.greedy"),
            icon: "trending-up-outline",
            route: "greedy-algorithm",
            right: null,
          },
          {
            name: "Dynamic Programming",
            displayName: t("topics.dp"),
            icon: "code-outline",
          ...
          },
          {
            ...
            displayName: t("topics.graphAlgo"),
            icon: "share-social-outline",
          ...
          {
            name: "Recursion",
            displayName: t("topics.recursion"),
    ...
    return (
      <View>
        <View style={styles.categoryHeader}>
          <View>
            <Text
              style={[typography.labelMedium, { color: theme.textSecondary }]}
            >
        ...
        <Expandables
          ...
          theme={theme}
          onSelected={(topic) => {
            const originalTopic = item.topics.find(
              (ot) => ot.displayName === topic.name,
            );
            if (originalTopic) {
