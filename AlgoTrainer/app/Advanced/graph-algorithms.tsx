    ...
    const modules = useMemo(() => [
        {
            id: "1",
            type: "subheading",
            text: t('topicContent.graphAlgo.title'),
            paragraph: t('topicContent.graphAlgo.description')
        },
        {
            id: "2",
            type: "subheading",
            text: t('topicContent.graphAlgo.whyTitle'),
            paragraph: t('topicContent.graphAlgo.whyDesc')
        },
        {
            id: "3",
            type: "list",
            ...
            <FlatList
                ...
                ListFooterComponent={
                    <View style={styles.buttonContainer}>
                        <Pressable style={styles.btn} onPress={() => router.push('/AdvanceVisual/graph-visual')}>
